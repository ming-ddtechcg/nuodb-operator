...
local dep_tmpl="spec.install.spec.deployments[0].spec.template.spec.containers[0].image"
yq w olm-catalog/nuodb-operator/0.0.5/nuodb.v0.0.5.clusterserviceversion.yaml "$dep_tmpl" "$NUODB_OP_IMAGE"
